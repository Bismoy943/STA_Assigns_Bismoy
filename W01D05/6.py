...
elif hc<hp and hc<op and lc>cp and lc>lp:
    print("Current bar is bullish harami")
elif hc<hp and hc<cp and lc>op and lc>lp:
    print("Current bar is bearish harami")
elif lc<lp and lc<cp and oc<cp and hc<hp and cc<op and hc<op:
    print("Current bar is rising sun")
elif lc>lp and lc>op and cc>op and hc>hp and oc>cp and hc>cp:
